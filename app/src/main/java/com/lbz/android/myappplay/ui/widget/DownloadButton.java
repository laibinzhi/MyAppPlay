...
public class DownloadButton extends TextView {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        DownloadButton.SavedState ss = (DownloadButton.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        return new DownloadButton.SavedState(superState, (int) mProgress, mState, mCurrentText.toString());
    }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            ...
            @Override
            public DownloadButton.SavedState createFromParcel(Parcel in) {
                return new DownloadButton.SavedState(in);
            }

            @Override
            public DownloadButton.SavedState[] newArray(int size) {
                return new DownloadButton.SavedState[size];
            }
        };
    }
