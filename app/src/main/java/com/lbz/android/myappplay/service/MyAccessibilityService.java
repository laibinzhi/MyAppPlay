package com.lbz.android.myappplay.service;
...
public class MyAccessibilityService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        Log.e(TAG,"onAccessibilityEvent ="+event.getPackageName()+event.getClassName().toString());
    ...
    private void processInstalledEvent(AccessibilityNodeInfo nodeInfo) {
        Log.e(TAG,"processInstalledEvent" );
    ...
    private void findAndPerformAction(String text, AccessibilityNodeInfo source) {
        Log.e(TAG,"findAndPerformAction ="+text );
